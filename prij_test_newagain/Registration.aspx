    ...
    <form id="form1" runat="server">
        ...
        <div style =" width:500px; height:560px; margin-top:100px;margin:auto; background-color:gray; text-align:center; background-color:#ffffff; border:medium; border-radius: 25px;">
            <div style="position:relative;top:56px; left: 0px;">
                ...
                <br /><br/>
                <asp:TextBox ID="rePasswordTextBox" runat="server" placeholder="Re-enter password " Style="border: 1px solid #c8c8c8; border-radius: 10px; padding: 5px; font-family:verdana; border-color:#32323D" />
                <br /><br/>
                ...
                <br />  
                <asp:Label ID="errorLabel" Text="null" runat="server" Visible="false" Style="font-size:10px; font-family:verdana;" />
             </div>
